...
export default function LandingPage(){
    return(
        ...
        <main className="flex-grow flex flex-col items-center text-center px-6 py-12">
            ...
            <Link to="/signup"className="px-6 py-3 rounded-2xl bg-indigo-600 text-white font-semibold text-lg shadow-lg hover:bg-indigo-700 transition">Getting Started</Link>
            {/*feature 1 */}
