// -----------------------------------------------------------------------------
// File: ResponseSheet.jsx
// Purpose:
//   - Displays a detailed answer sheet for a user's quiz attempt inside a modal.
//   - Shows score, correct/wrong/left summary, and all question-wise responses.
//   - Highlights correct, wrong, and selected options with colors.
//   - Allows downloading the answer sheet as a PDF using html2pdf.js.
//   - Supports closing by clicking outside or using the close button.
// -----------------------------------------------------------------------------
